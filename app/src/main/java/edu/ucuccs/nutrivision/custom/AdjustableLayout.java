...
public class AdjustableLayout extends LinearLayout {
    ...
    private final List<LinearLayout> listHorizontalLayouts = new ArrayList<>();
    private final List<View> listChildViews = new ArrayList<>();
    private final List<Integer> listChildViewWidth = new ArrayList<>();
